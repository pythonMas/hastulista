            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                        <h3 class="panel-title">Productos para esta Orden</h3>
                    </div>
                        ...
                        <ul>
                            @foreach ($products as $product)
                                <li style="margin-bottom: 10px">
                                    <div>Identificación de producto: {{ $product->id }}</div>
                                    <div>Nombre del Producto: {{ $product->name }}</div>
                                    <div>Precio del producto: {{ $product->presentPrice() }}</div>
                                    <div>La cantidad de producto: {{ $product->pivot->quantity }}</div>
                                </li>
                            @endforeach
                        </ul>
                    </div>
